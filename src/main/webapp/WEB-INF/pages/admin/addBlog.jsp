...
<div class="container">
    ...
    <hr/>
    <form:form action="${pageContext.request.contextPath}/admin/blogs/addP" method="post" commandName="blog" role="form">
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" id="pubDate" name="pubDate" placeholder="Please Input Publish Date:(yyyy/MM/dd)"/>
        </div>
        <div class="form-group">
