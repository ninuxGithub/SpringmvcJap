        ...
        <table class="table table-bordered table-striped">
            ...
            <c:forEach items="${blogList}" var="blog">
                <tr>
                    <td>${blog.id}</td>
                    <td>${blog.title}</td>
                    <td>${blog.userEntity.nickname}, ${blog.userEntity.firstName} ${blog.userEntity.lastName}</td>
                    ...
                    <td>
                        ...
                        <a href="${pageContext.request.contextPath}/admin/blogs/delete/${blog.id}" type="button" onclick="return confirm('确定删除吗？')" class="btn btn-sm btn-danger">删除</a>
                    </td>
                </tr>
            </c:forEach>
        </table>
