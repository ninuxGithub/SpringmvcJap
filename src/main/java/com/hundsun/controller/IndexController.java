...
public class IndexController {
	...
	public String index(Model model) {
		...
		while (iterator.hasNext()) {
			Map.Entry<RequestMappingInfo, HandlerMethod> entry = (Map.Entry<RequestMappingInfo, HandlerMethod>) iterator
					.next();
			// System.out.println(entry.getKey() +"\n" + entry.getValue());
			String method = entry.getKey().getMethodsCondition().toString()+ "</br>";
			String url = entry.getKey().getPatternsCondition().toString() ;
			// System.out.println("url:" + url + " &&& method is :" + method);
			urls.put(url, method);
		}
	...
	public String addUserPost(UserEntity userEntity) {
